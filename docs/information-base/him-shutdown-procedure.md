...
![HIM shutdown procedure - page 1](../../assets/img/pdf-pages/him-shutdown-procedure/page-001.webp)

*Page 1 facsimile from `HIM_shutdown_procedure.pdf`.*
...
![HIM shutdown procedure - page 2](../../assets/img/pdf-pages/him-shutdown-procedure/page-002.webp)

*Page 2 facsimile from `HIM_shutdown_procedure.pdf`.*
...
![HIM shutdown procedure - page 3](../../assets/img/pdf-pages/him-shutdown-procedure/page-003.webp)

*Page 3 facsimile from `HIM_shutdown_procedure.pdf`.*
...
![HIM shutdown procedure - page 4](../../assets/img/pdf-pages/him-shutdown-procedure/page-004.webp)

*Page 4 facsimile from `HIM_shutdown_procedure.pdf`.*
