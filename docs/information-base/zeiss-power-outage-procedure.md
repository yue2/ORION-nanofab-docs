...
![ZEISS Power Outage Procedure - page 1](../../assets/img/pdf-pages/zeiss-power-outage-procedure/page-001.webp)

*Page 1 facsimile from `ZEISS_Power_Outage_Procedure.pdf`.*
...
![ZEISS Power Outage Procedure - page 2](../../assets/img/pdf-pages/zeiss-power-outage-procedure/page-002.webp)

*Page 2 facsimile from `ZEISS_Power_Outage_Procedure.pdf`.*
...
![ZEISS Power Outage Procedure - page 3](../../assets/img/pdf-pages/zeiss-power-outage-procedure/page-003.webp)

*Page 3 facsimile from `ZEISS_Power_Outage_Procedure.pdf`.*
...
![ZEISS Power Outage Procedure - page 4](../../assets/img/pdf-pages/zeiss-power-outage-procedure/page-004.webp)

*Page 4 facsimile from `ZEISS_Power_Outage_Procedure.pdf`.*
...
![ZEISS Power Outage Procedure - page 5](../../assets/img/pdf-pages/zeiss-power-outage-procedure/page-005.webp)

*Page 5 facsimile from `ZEISS_Power_Outage_Procedure.pdf`.*
...
![ZEISS Power Outage Procedure - page 6](../../assets/img/pdf-pages/zeiss-power-outage-procedure/page-006.webp)

*Page 6 facsimile from `ZEISS_Power_Outage_Procedure.pdf`.*
...
![ZEISS Power Outage Procedure - page 7](../../assets/img/pdf-pages/zeiss-power-outage-procedure/page-007.webp)

*Page 7 facsimile from `ZEISS_Power_Outage_Procedure.pdf`.*
